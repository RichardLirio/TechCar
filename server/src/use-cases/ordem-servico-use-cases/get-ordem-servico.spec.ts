...
describe("Get Ordem de Servico Use Case", () => {
  beforeEach(() => {
  ...
  // Testes do caso de uso de buscar ordemservico
  it("Está sendo possivel buscar os dados de uma Ordem de Servico", async () => {
  ...
  it("Não deverá ser possivel buscar uma ordem de servico com id invalido", async () => {
    await expect(() =>
      sut.execute({
        ordemServicoId: 0,
      })
